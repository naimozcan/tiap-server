const enums = {
    ...
    ORDER_REGEX: /^OBR(?:19|20)\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])(?!000000)\d{6}E$/,
    PICKING_REGEX: /^PIR(?:19|20)\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])(?!000000)\d{6}E$/,
    PACKING_REGEX: /^PAR(?:19|20)\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])(?!000000)\d{6}E$/,
